...
_FLAG_SVG = {
    "KR": (
        ...
        '<path d="M12 3.8a4.2 4.2 0 0 1 0 8.4 2.1 2.1 0 0 1 0-4.2 2.1 2.1 0 0 0 0-4.2z" fill="#cd2e3a"/>'
        '<path d="M12 12.2a4.2 4.2 0 0 1 0-8.4 2.1 2.1 0 0 1 0 4.2 2.1 2.1 0 0 0 0 4.2z" fill="#0047a0"/>'
        '</svg>'
    ),
    "US": (
        '<svg class="fico" viewBox="0 0 24 16" xmlns="http://www.w3.org/2000/svg">'
